# Java Full Stack — Deepskills

Hands-on practice modules covering core Java Full Stack engineering concepts.
...
| # | Module | Type | Topics | Status |
|---|--------|------|--------|--------|
| 1 | SOLID Principles & Design Patterns | Hands-on | SRP, OCP, LSP, ISP, DIP, Singleton, Factory, Adapter, Decorator, Observer, MVC, DI | ✅ Completed |
| 2 | Data Structures & Algorithms | Hands-on | Arrays, LinkedList, Stack, Queue, Binary Tree, Linear/Binary Search, Bubble/Quick Sort, HashMap, Recursion | ✅ Completed |
...
| 13 | Docker | Concept | Images, Containers, Dockerfile, Docker Compose, Volume mounts, Networking | ⏳ Upcoming |
| 14 | Agile | Concept | Scrum, Sprints, Stand-ups, Retrospectives, User stories, Estimation | ⏳ Upcoming |
| 15 | Cloud | Concept | AWS/Azure basics, IaaS/PaaS/SaaS, Deployment, Scaling, Storage | ⏳ Upcoming |
| 16 | GenAI | Concept | Prompt engineering, LLMs, RAG, Fine-tuning, AI integration patterns | ⏳ Upcoming |
| 17 | Angular | Workshop | Components, Modules, Routing, Services, Pipes, Directives, CLI | ⏳ Upcoming |

## Legend

| Icon | Meaning |
|------|---------|
| ✅ Completed | All exercises done and submitted |
